...
export const TOKEN_LOCALE = new InjectionToken<string>(
  'initialize and runtime locale',
)

export const TOKEN_DEFAULT_LOCALE = new InjectionToken<string>(
  'fallback locale if translation for current locale found',
)

export const TOKEN_LOCALES = new InjectionToken<string[]>(
